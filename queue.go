...
//
// These six methods run the queue. Listing it, counting it, reviving a dead job
// and pruning finished ones are operating it, and live in the ops subpackage
// with everything else nothing on the write or read path calls.
